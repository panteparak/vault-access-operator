...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncStatusAccessor) DeepCopyInto(out *SyncStatusAccessor) {
	*out = *in
	if in.s != nil {
		in, out := &in.s, &out.s
		*out = new(SyncStatus)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncStatusAccessor.
func (in *SyncStatusAccessor) DeepCopy() *SyncStatusAccessor {
	if in == nil {
		return nil
	}
	out := new(SyncStatusAccessor)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VaultClusterPolicyStatus) DeepCopyInto(out *VaultClusterPolicyStatus) {
	*out = *in
	...
	if in.UsedByRoles != nil {
		in, out := &in.UsedByRoles, &out.UsedByRoles
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultRoleJWTSpec) DeepCopyInto(out *VaultRoleJWTSpec) {
	*out = *in
	...
	if in.BoundClaimsList != nil {
		in, out := &in.BoundClaimsList, &out.BoundClaimsList
		*out = make(map[string][]string, len(*in))
		for key, val := range *in {
			var outVal []string
			if val == nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultRoleJWTSpec.
func (in *VaultRoleJWTSpec) DeepCopy() *VaultRoleJWTSpec {
	if in == nil {
		return nil
	}
	out := new(VaultRoleJWTSpec)
