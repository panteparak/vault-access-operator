...
func TestDeletionSuite(t *testing.T) {
	...
	RunSpecs(t, "Deletion Integration Test Suite", suiteConfig, reporterConfig)
}
...
var _ = BeforeSuite(func() {
	...
	By("Setting up deletion test context")
	ctx, cancel := context.WithCancel(context.Background())
	integration.SetContext(ctx, cancel)

	By("Creating deletion test environment")
	...
	By("Starting deletion test environment")
	...
	DeferCleanup(func() {
		By("Stopping deletion test environment")
